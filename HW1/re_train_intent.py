...
def save_checkpoint(model,epoch,ckpt_dir):
  ckpt_path=ckpt_dir/"epoch_{}_model.pth".format(epoch+1)
...
def main(args):
    ...
    for epoch in epoch_pbar:
        ...
        if val_accuracy>best_acc:
          ...
          best_acc_loss=valid_epoch_loss
          ...
          file_name="best_re_loss_model.pth"
    ...
    f.write("best valid acc_epoch:"+str(best_acc_epoch)+"\n")
    f.write("best valid acc:"+str(best_acc)+"\n")
    f.write("best valid acc_loss:"+str(best_acc_loss)+"\n")
    f.write("best valid loss_epoch:"+str(best_loss_epoch)+"\n")
    f.write("best valid loss_acc:"+str(best_loss_acc)+"\n")
    f.write("best valid loss:"+str(best_valid_loss)+"\n")
...
def parse_args() -> Namespace:
    ...
    parser.add_argument(
        ...
        default="./ckpt/intent/best_loss_model.pth"
    )
    ...
    parser.add_argument("--scheduler",help="'type:MultiStepLR,OneCycleLR,StepLR,ReduceLROnPlateau,ExponentialLR,CosineAnnealingLR,LambdaLR",default='reduce', type=str)
